          ...
          <div v-if="!searchQuery" class="popular-banks-section">
            ...
            <div class="banks-grid">
              ...
              >
                ...
                <div class="bank-logo" :style="{ backgroundColor: bank.color + '20', color: bank.color }">
          ...
          <div v-if="searchQuery" class="search-results-section">
            ...
            <div v-else class="banks-list">
              ...
              >
                ...
                <div class="search-bank-logo" :style="{ backgroundColor: bank.color + '20', color: bank.color }">
                  <svg class="bank-icon" viewBox="0 0 24 24" fill="currentColor">
                    <path :d="bank.icon"/>
                  </svg>
                </div>
                ...
                <div class="bank-status">
                  <span class="status-indicator" :class="bank.status">
                    ...
                    <svg v-else viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,12 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12A6,6 0 0,1 12,18A6,6 0 0,1 6,12A6,6 0 0,1 12,6M12,8A4,4 0 0,0 8,12A4,4 0 0,0 12,16A4,4 0 0,0 16,12A4,4 0 0,0 12,8Z"/>
                    </svg>
