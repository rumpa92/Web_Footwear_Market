...
export default {
  ...
  data() {
    return {
      ...
      // All banks list including popular and others
      allBanks: [
        {
          id: 'sbi',
          name: 'State Bank of India',
        ...
        },
        {
          ...
          logo: 'https://images.unsplash.com/photo-1554224154-26032fbc4d2f?w=120&h=80&fit=crop&crop=center',
          status: 'available'
        },
        {
          id: 'canara',
          name: 'Canara Bank',
          description: 'Nationalized bank',
          logo: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?w=120&h=80&fit=crop&crop=center',
          status: 'available'
        },
        {
          id: 'union',
          name: 'Union Bank of India',
          description: 'Merged public sector bank',
          logo: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?w=120&h=80&fit=crop&crop=center',
          status: 'available'
        },
        {
          id: 'bob',
          ...
          logo: 'https://images.unsplash.com/photo-1556742111-a301076d9d18?w=120&h=80&fit=crop&crop=center',
          status: 'available'
        },
        {
          id: 'idbi',
          name: 'IDBI Bank',
          description: 'Development banking',
          logo: 'https://images.unsplash.com/photo-1563986768711-ca916ad1c435?w=120&h=80&fit=crop&crop=center',
          status: 'maintenance'
        },
        {
          id: 'yes',
